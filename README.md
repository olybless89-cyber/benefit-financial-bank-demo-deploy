...
| `SUPABASE_ANON_KEY` | no | Anon key used wen re-writing the embedded config at serve time (self-hosted override). |
...
**Benefit Financial Bank** (independent project.. The original template is
